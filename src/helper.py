...
mock = {
    ...
    "CCS12": {
        ...
        "latest_announcement": "<p>Good day everyone,</p><p>Please be informed that we will have to cancel the synchronous learning classes today. Please continue with reading the materials and finalizing the activities.</p><p>For your guidance. Please disseminate. Apologies for the immediate change of schedule.</p>",
        "pending_assignments": {
            "464340": {
                "name": "6.2.2: Website Assets",
                "points": 30.0,
                "description": "<h4>Individually or by pairs, create a file that shows all of the assets required for the company website.</h4>\n<ul>\n<li>Please refer to your brand guidelines, company logo, and previous activities to reference how the website may look like.</li>\n<li>Include the following (but not limited to) as the assets:\n<ul>\n<li>Images</li>\n<li>Icons</li>\n<li>Navigation design</li>\n<li>Button design and its variations</li>\n<li>Other UI icons and widgets</li>\n</ul>\n</li>\n<li>For the images and icons, you are free to create your own, or get them from reputable sources (such as freepik.com for icons). However, please make sure to cite / attribute your sources at the bottom left portion of the output and dedicate another webpage on your prototype (later activity) for all of the citations / attributions.</li>\n<li>It is important for you to maintain consistency in the designs of your output.</li>\n<li>Place all of the assets into one image output with the following dimensions:\n<ul>\n<li>Dimensions: 1920 px x 1080 px</li>\n<li>Resolution: 150 dpi - 300 dpi</li>\n</ul>\n</li>\n<li>Place all of your citations / attributions on the bottom left portion of your output.</li>\n<li>Submit as an image (PNG) file.</li>\n</ul>\n<p><em><strong>Sample Output:</strong></em></p>\n<p><img src=\"https://assets.justinmind.com/wp-content/webp-express/webp-images/uploads/2019/04/justinmind-web-components.png.webp\"></p>",
                "due": "November 08, 2023 03:59 PM",
                "due_today": False
            },
            "464342": {
                "name": "Lab Act 4: Organization Website",
                "points": 100.0,
                "description": "<h4>Individually or in pairs, create a prototype of a website for your company.</h4>\n<p><strong>Information Requirements</strong></p>\n<ul>\n<li>Please use the information from the previous activities, namely \"Company Website Content\" and \"Company Website Assets\".\n<ul>\n<li>Landing page</li>\n<li>About the company (you can include mission and vision)</li>\n<li>Products / services offered</li>\n<li>Frequently asked questions (around 3)</li>\n<li>At least three blog articles related to your company</li>\n<li>Contact information</li>\n</ul>\n</li>\n<li>Take note to create a webpage that shows all attributions and references.</li>\n</ul>\n<p><strong>Website</strong></p>\n<ul>\n<li>You are not meant to create a website by coding. You are meant to create a website using prototyping tools:\n<ul>\n<li>Figma - <a class=\"external\" href=\"https://www.figma.com/\" target=\"_blank\"><span>https://www.figma.com/</span><span class=\"external_link_icon\" role=\"presentation\"><span class=\"screenreader-only\">Links to an external site.</span></span></a>&nbsp;</li>\n<li>Marvel - <a class=\"external\" href=\"https://marvelapp.com/\" target=\"_blank\"><span>https://marvelapp.com/</span><span class=\"external_link_icon\" role=\"presentation\"><span class=\"screenreader-only\">Links to an external site.</span></span></a></li>\n<li>Proto.io - <a class=\"external\" href=\"https://proto.io/\" target=\"_blank\"><span>https://proto.io/</span><span class=\"external_link_icon\" role=\"presentation\"><span class=\"screenreader-only\">Links to an external site.</span></span></a></li>\n<li>Adobe XD</li>\n<li>Adobe InDesign</li>\n</ul>\n</li>\n<li>You are free to use content management websites (Wordpress, Weebly, Wix, etc.) but is not recommended since the level of customization is very limited.</li>\n<li>You are free to use either a desktop version or a mobile version. Please refer to the following measurements:\n<ul>\n<li>Desktop - 1920px x 1080px</li>\n<li>Mobile - 1080px x 1920px</li>\n</ul>\n</li>\n<li>Ensure consistency in the layout, design, and overall user experience of the website. Use the assets created to maintain consistency.</li>\n<li>Include user experience by making sure that the navigation and buttons are seemingly functional.\n<ul>\n<li>For the aforementioned websites, there should be a \"Prototyping\" tab that allows you to connect \"buttons\" to particular webpages.</li>\n</ul>\n</li>\n</ul>\n<p><strong>Webpages</strong></p>\n<ul>\n<li>The company website must have at least the following webpages placed in the navigation bar:\n<ul>\n<li>Landing page</li>\n<li>Products and services</li>\n<li>Blog</li>\n<li>About</li>\n</ul>\n</li>\n<li>There should be one webpage where all the attributions and citations are placed.</li>\n</ul>\n<p><strong><span>Output and Submission</span></strong></p>\n<ul>\n<li><span>Submit your output as a website link.</span></li>\n<li><span>Make sure that the website is functional to all.</span>\n<ul>\n<li><span>To ensure this, you can open the link in an incognito tab and/or another web browser.</span></li>\n<li><span>If the website is not functional, then the output will be marked as zero.</span></li>\n</ul>\n</li>\n</ul>",
                "due": "November 11, 2023 03:59 PM",
                "due_today": False
            }
        },
    ...
    "CC5": {
        ...
        "latest_announcement": "Good morning everyone! Kindly please utilize this period to install xampp. For mac users, i recommend mamp.<div><br></div><div>Xampp :&nbsp;<a href=\"https://www.apachefriends.org/index.html\">https://www.apachefriends.org/index.html</a></div><div>Mamp:&nbsp;<a href=\"https://www.mamp.info/en/mac/\">https://www.mamp.info/en/mac/</a></div><div><br></div><div>Thank you!</div>",
        "pending_assignments": {},
